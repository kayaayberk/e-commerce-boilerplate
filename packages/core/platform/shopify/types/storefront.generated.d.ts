...
export type CreateCustomerMutation = { customerCreate?: StorefrontTypes.Maybe<{ customerUserErrors: Array<Pick<StorefrontTypes.CustomerUserError, 'code' | 'field' | 'message'>>, customer?: StorefrontTypes.Maybe<Pick<StorefrontTypes.Customer, 'id' | 'firstName' | 'lastName' | 'email' | 'phone' | 'acceptsMarketing' | 'displayName' | 'tags' | 'createdAt' | 'updatedAt'>> }> };
...
export type PredictiveSearchQuery = { predictiveSearch?: StorefrontTypes.Maybe<{ queries: Array<Pick<StorefrontTypes.SearchQuerySuggestion, 'text' | 'styledText' | 'trackingParameters'>>, collections: Array<Pick<StorefrontTypes.Collection, 'id'>>, products: Array<(
      Pick<StorefrontTypes.Product, 'id' | 'handle' | 'title' | 'description' | 'descriptionHtml' | 'vendor' | 'tags' | 'updatedAt' | 'createdAt'>
      & { options: Array<Pick<StorefrontTypes.ProductOption, 'id' | 'name' | 'values'>>, priceRange: { maxVariantPrice: Pick<StorefrontTypes.MoneyV2, 'amount' | 'currencyCode'>, minVariantPrice: Pick<StorefrontTypes.MoneyV2, 'amount' | 'currencyCode'> }, collections: { nodes: Array<(
          Pick<StorefrontTypes.Collection, 'handle' | 'title' | 'description' | 'updatedAt' | 'id' | 'descriptionHtml'>
          & { image?: StorefrontTypes.Maybe<Pick<StorefrontTypes.Image, 'url' | 'altText' | 'width' | 'height'>> }
