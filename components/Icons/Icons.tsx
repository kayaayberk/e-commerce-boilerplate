// prettier-ignore
import { ArrowLeft, ChevronDown, CircleUserRound, Facebook, Heart, Instagram, Link, Linkedin, LoaderCircle, LucideProps, PencilLine, Search, ShoppingCart, Slash, SlidersHorizontal, Twitter, X, Youtube } from 'lucide-react'
